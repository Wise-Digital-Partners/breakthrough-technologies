      ...
      return (
         <StyledForm>
            <div id="download-form-ajax-response">
               {this.state.isSubmitted && <ButtonSolid href={downloadFile} target="_blank" text="Download Guide" />}
            </div>
            <form name="PDF Lead Magnet" method="post" action="" data-netlify="true" data-netlify-honeypot="bot-field" onSubmit={this.handleSubmit}>
               ...
               <div className="mt-2">
                  <ButtonGhost as="button" type="submit" text="Download Guide" />
               </div>
            </form>
         </StyledForm>
      );
