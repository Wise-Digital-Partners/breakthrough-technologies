   ...
   render() {
      return (
         <StyledForm>
            ...
            <form name="Newsletter" method="post" action="" data-netlify="true" data-netlify-honeypot="bot-field" onSubmit={this.handleSubmit}>
               ...
               <ButtonSolid as="button" type="submit" darkmode={true} text="Subscribe" />
            </form>
         </StyledForm>
      );
   }
