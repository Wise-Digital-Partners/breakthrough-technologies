            ...
            render={(data) => (
               <StyledSlider>
                  ...
                  <Slick {...sliderSettings}>
                     <div>
                        <div className="grid md:grid-cols-2 gap-y-10 md:gap-x-10 lg:gap-x-20">
                           ...
                           <div className="md:pt-4 lg:pt-7 md:pr-10 lg:pr-20">
                              <span className="text-primary-400 font-heading font-black text-4xl hidden md:block mb-1">01</span>
                              <h3 className="heading-four font-light">Fully Licensed Design - Architectural, Structural & Civil</h3>
                              <p>
                                 Our team of expert draftsmen provide a high-quality design and drafting experience. We take your ideas and turn them
                                 into reality through sketching, drafting, and 3D renderings. And we do it your way. At Design Appruv, we always
                                 include our clients in every step of the design process.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div>
                        <div className="grid md:grid-cols-2 gap-y-10 md:gap-x-10 lg:gap-x-20">
                           ...
                           <div className="md:pt-4 lg:pt-7 md:pr-10 lg:pr-20">
                              <span className="text-primary-400 font-heading font-black text-4xl hidden md:block mb-1">02</span>
                              <h3 className="heading-four font-light">Building Permits</h3>
                              <p>
                                 We alleviate the stress and confusion of the building permit process. We stay in contact with your building permit
                                 office to maintain your project's integrity and adhere to your timeline. Other services including conditional use
                                 permits, occupancy permits, and food and alcohol permits.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div>
                        <div className="grid md:grid-cols-2 gap-y-10 md:gap-x-10 lg:gap-x-20">
                           ...
                           <div className="md:pt-4 lg:pt-7 md:pr-10 lg:pr-20">
                              <span className="text-primary-400 font-heading font-black text-4xl hidden md:block mb-1">03</span>
                              <h3 className="heading-four font-light">Construction Administration</h3>
                              <p>
                                 We’re proud to be one of the only vertically integrated drafting and construction bidding & administration teams in
                                 San Diego County. From initial budgeting and scheduling to onsite leadership and management, our experienced project
                                 management team caters to your specific needs.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div>
                        <div className="grid md:grid-cols-2 gap-y-10 md:gap-x-10 lg:gap-x-20">
                           ...
                           <div className="md:pt-4 lg:pt-7 md:pr-10 lg:pr-20">
                              <span className="text-primary-400 font-heading font-black text-4xl hidden md:block mb-1">04</span>
                              <h3 className="heading-four font-light">Photorealistic Rendering</h3>
                              <p>
                                 Need to visualize your project even more before it gets built? See your design from the inside out with our
                                 photorealistic rendering services. With HGTV levels of animation, get a 360-degree view of the project with
                     ...
                     <div>
                        <div className="grid md:grid-cols-2 gap-y-10 md:gap-x-10 lg:gap-x-20">
                           ...
                           <div className="md:pt-4 lg:pt-7 md:pr-10 lg:pr-20">
                              <span className="text-primary-400 font-heading font-black text-4xl hidden md:block mb-1">05</span>
                              <h3 className="heading-four font-light">Real Estate Photography</h3>
                              <p>
                                 Make a great first impression with high-quality images. Design Appruv offers drone photography, 3D walkthroughs, and
                                 cinematic marketing videos for interior & exterior areas. Showcase the best of your project with our professional
                  ...
                  <div className="hidden md:flex items-center absolute right-0 bottom-0 md:mr-10 lg:mr-20">
                     <button onClick={this.prevSlide} className="hidden md:block focus:outline-none">
                     ...
                     <button onClick={this.nextSlide} className="hidden md:block focus:outline-none">
